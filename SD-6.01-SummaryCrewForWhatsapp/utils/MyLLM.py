...
class MyLLM():
    ...
    Ollama_llama_3_2        = LLM(model="ollama/llama3.2:latest", base_url=OLLAMA_BASE_URL)
    Ollama_deepseek_14b     = LLM(model="ollama/deepseek-r1:14b", base_url=OLLAMA_BASE_URL)
    Ollama_qwen3            = LLM(model="ollama/qwen3:8b",base_url=OLLAMA_BASE_URL)
    Ollama_gemma3           = LLM(model="ollama/gemma3:latest",base_url=OLLAMA_BASE_URL)
