...
class MyLLM():
    ...
    Ollama_qwen3            = LLM(model="ollama/qwen3:8b",base_url=OLLAMA_BASE_URL,max_tokens=4096,max_completion_tokens=2048,timeout=1200)
    Ollama_devstral         = LLM(model="ollama/devstral:latest",base_url=OLLAMA_BASE_URL,max_tokens=4096,max_completion_tokens=2048,timeout=1200)
